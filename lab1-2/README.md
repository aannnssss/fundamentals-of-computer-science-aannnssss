...
Работа выполнена: «27» сентября 2022 г.

Преподаватель: Сахарин Никита Андреевич

Входной контроль знаний с оценкой:

Отчёт сдан: « 1 » октября 2022 г. Итоговая оценка:

Подпись преподавателя:

Тема: Операционная среда OC UNIX.

Цель работы: Изучение и освоение программного обеспечения OC UNIX и приобретение навыков, необходимых для выполнения курсовых и лабораторных работ в среде OC UNIX.

Задание: Приобретение основных навыков в работе OC UNIX на рабочих станциях в окнах текстовых терминалов. Навигация в иерархической файловой системе OC UNIX. Создание, копирование, переименование и удаление файлов и каталогов. Работа с текстовым редактором Emacs. Освоение сервисных функций, оконных интерфейсов Unix.
...
Долго не получилось установить Virtualbox, пришлось скачать UTM и разбираться во всем самой
...
Благодаря лабораторной работе я приобрела первоначальные навыки по работе с OC UNIX. Я научилась перемещаться по директориям, создавать, копировать, вставлять, редактировать, удалять файлы. Я ознакомилась с утилитой Gnuplot, с её помощью смогла построить сферу и другие фигуры, графики. Имея данные навыки, в будущем  я смогу полностью изучить OC UNIX.
